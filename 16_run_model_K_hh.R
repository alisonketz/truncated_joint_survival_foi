...
nimData <- list(
    ...
    rec_neg_cens_postno_age2date = rec_neg_cens_postno_age2date,
    rec_neg_cens_postno_dn1 = d_fit_rec_neg_cens_postno$ageweek_recap,
    y_rec_neg_mort = 1,
    ...
    rec_pos_cens_dn = d_fit_rec_pos_cens$ageweek_recap,
...
nimConsts <- list(
    ...
    nRecNegCensPostNo = nrow(d_fit_rec_neg_cens_postno),
